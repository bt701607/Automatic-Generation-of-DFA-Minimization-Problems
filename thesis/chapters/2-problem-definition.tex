...
\begin{figure}[h]
	...
	\itshape Apply the minimization algorithm and show for each state pair during which \CompDist-iteration it was marked. Draw the resulting automaton.

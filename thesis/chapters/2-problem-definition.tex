...
\begin{figure}[H]
	...
	\resizebox{1.\linewidth}{!}{
		...
		\node[accepting,state] (2) at (2, 1.5) {$2$};
		...
		(1) edge 			  node [below left]  {$b$}   (3)
		(3) edge [loop below] node [loop below]  {$a,b$} (3)
		(4) edge 			  node [above right] {$a$}   (2)
		(5) edge [loop below] node [below]	     {$a$}   (5)
		;
		\end{tikzpicture}
	}
	\end{subfigure}
